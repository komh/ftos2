...
say "Facename alias flag updated to " || val || ". Please reboot to activate changes."
pause
exit
...
say 'The current facename alias flag is ' || val
pause
exit

usage:
say 'This program is used to set the flag of using facename alias.'
say
say 'Usage: FALIAS q         - query the current flag'
say '       FALIAS s  <val>  - set flag to <val=0|1> (effective on next reboot).'
pause
