...
say "Netscape fix flag updated to " || val || ". Please reboot to activate changes."
pause
exit
...
say 'The current netscape fix flag is ' || val
pause
exit

usage:
say 'This program is used to set the flag of using netscape fix.'
say
say 'Usage: NETFIX q         - query the current flag'
say '       NETFIX s  <val>  - set flag to <val=0|1> (effective on next reboot).'
pause
