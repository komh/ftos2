...
A8: First, you should modify a country code of CONFIG.SYS to your country code.
    For examples,
        COUNTRY=082,X:\OS2\SYSTEM\COUNTRY.SYS
    where 082 is a country code for Korean.

    Second, set 'LANG' env. var.
    For examples,
        LANG=KO_KR
    where KO_KR is a value for Korean.
    By this, you can see DBCS chars on Bookmark of Mozilla.

    Finally, if you want to see your native face name of fonts, you should
    modify your primary codepage of CONFIG.SYS.
    For examples,
        CODEPAGE=949,850
    949 is a codepage for Korean. But I don't recommend this because using DBCS
    primary codepage on non-DBCS OS/2 can cause unexpectable problems.
...
- Current features/bugs/limitations:
 ...
 Features   : - outlines
              ...
              - decode font name in according to primary codepage.
              - DBCS support
                - supports SBIT fonts.
 ...
 Bug/feature: - unharmonious glyph spacing in some applications. This seems
              ...
              - some unicode fonts for DBCS shipped with OS/2, don't work with
                FreeType/2. Recommend to use fonts from M$ instead.
...
Greetings can also be sent directly to the author at :
   mike@mendelu.cz
   acrab001@hitel.net
   komh@chollian.net
