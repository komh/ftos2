...
say "Fake bold flag updated to " || val || ". Please reboot to activate changes."
pause
exit
...
say 'The current fake bold flag is ' || val
pause
exit

usage:
say 'This program is used to set the flag of using fake bold'
say
say 'Usage: FAKEBOLD q         - query the current flag'
say '       FAKEBOLD s  <val>  - set flag to <val=0|1> (effective on next reboot).'
pause
